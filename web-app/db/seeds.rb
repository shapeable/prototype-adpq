...
category_2 = AlarmCategory.create(name: 'Meeting Points & Collection Centers',name_es: "Puntos de reunion y centros de acopio", description: 'Know about safe places for emergency and places for helping those in neeed.')
